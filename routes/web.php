...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('getPatologiasGenerales/{capituloId}', [RepososEnfermedadController::class, 'getPatologiasGenerales']);
    Route::get('getPatologiasEspecificas/{capituloId}', [RepososEnfermedadController::class, 'getPatologiasEspecificas']);
